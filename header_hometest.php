...
<html>
	<head>
		<title>John Teske, composer | <?php echo $title; ?></title>
		<meta charset="UTF-8">
	...
	<body id="top">
		...
		<header id="header" class="skel-layers-fixed">
			<nav id="nav" class="container">
				<ul class="row">
<!--
					<li class="3u 12u$(2)"><a href="/">John Teske, composer</a></li>
					<li class="3u 12u$(2)"><a href="/performances/">Performances</a></li>
					<li class="3u 12u$(2)"><a href="/compositions/">Compositions</a></li>
					<li class="3u 12u$(2)"><a href="/about.php">About</a></li>
-->
